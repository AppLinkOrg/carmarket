...
export class MemberApi{
    ...
    addfankui(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/addfankui',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    dashboard(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/dashboard',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    editenterprise(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/editenterprise',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
    ...
    editmoney(json, callback, showLoading = true) {
        ...
        console.log(json);
        wx.request({
            url: ApiConfig.GetApiUrl() + 'member/editmoney',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
